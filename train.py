...
parser.add_argument('--root_path', type=str, default='/home/psw/SAU-Net/data/COCA/COCA_3frames/train_npz', help='root dir for data')
...
if __name__ == "__main__":
    ...
    # output_file = "model_summary_sa.txt"
