...
parser.add_argument('--volume_path', type=str, default='/home/psw/AVS-Diagnosis/COCA/COCA_1frame/test_vol_h5', help='root dir for validation volume data')
...
parser.add_argument('--encoder', type=str, default='resnet50', help='for segmentation_models_pytorch encoder', choices=['resnet50', 'densenet201', 'efficientnet-b4', 'mit_b2'])
