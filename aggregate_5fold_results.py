"""
5-fold CV 결과 집계 (single_slice baseline 브랜치).
...
예:
  python aggregate_5fold_results.py \
      --exp_template review_5fold_baseline_resnet50_unet_fold{fold}_seed42 \
...
def main():
    ...
    ap.add_argument("--netclass", default=None,
                    help="NetClass 디렉터리명 직접 지정. 미지정 시 --decoder 매핑(Unet/Segformer) 사용")
