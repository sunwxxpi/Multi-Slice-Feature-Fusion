"""
5-fold CV 결과 집계 (EMCAD baseline 브랜치).
...
예:
  python aggregate_5fold_results.py \
      --exp_template review_5fold_emcad_fold{fold}_seed42 \
      --netclass EMCADNet --encoder pvt_v2_b2
"""
import os
import re
import glob
...
def main():
    ...
    ap.add_argument("--netclass", default=None,
                    help="NetClass 디렉터리명 직접 지정 (예: EMCADNet). 미지정 시 --decoder 매핑 사용")
    ...
    netcls = args.netclass or NETCLASS[args.decoder]
