...
예 (EMCAD-SA):
  python aggregate_5fold_results.py \
      --exp_template review_5fold_emcad_sa_fold{fold}_seed42 \
      --encoder pvt_v2_b2 --netclass EMCAD_SA_Net
"""
import os
import re
import csv
...
def main():
    ...
    ap.add_argument("--netclass", default=None,
                    help="net.__class__.__name__ 직접 지정 (예: EMCAD_SA_Net). 지정 시 --decoder 무시.")
